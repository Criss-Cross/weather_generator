...
monthList <- monthList['Month']
testSeasonalRainfall10 <- generateRainfallSeasonal(monthList)
simRainfall2019 <- testSeasonalRainfall10 # Removing day 278 and day 353 data from testSeasonalRainfall10
```
=======
set.seed(40565)
...
>>>>>>> 6dbe1e946ee0e9aa5fa2748415cbd216a70bc307
...
```{r, echo=FALSE}
set.seed(12345)
monthList <- subset(weather_data, Year == 2011)
monthList <- monthList['Month']
testSeasonalRainfall10 <- generateRainfallSeasonal(monthList)
<<<<<<< HEAD
