...
# Wilcoxon signed rank test on the data in 2019
...
# Since the p-value = 0.9695, it can be concluded that there is no significant diference between the simulated 2019 data and the actual 2019 data. This means that the data is not consistently too high or too low. 
