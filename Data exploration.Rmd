...
wilcox <- function(seed, year){
  ...
  par(mfrow = c(2,1))
 barplot(simRainfall, xlab = "Index", ylab = "Rainfall (mm)", main = "Simulated Rainfall")
 barplot(rainYear$Rainfall.amount..millimetres., xlab = "Index", ylab = "Rainfall (mm)",  main = "Actual Rainfall")
}
wilcox(40565, 2019)
```
